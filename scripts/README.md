...
- Reuse `scripts/lib/task_store.sh` for task package creation, lookup, repo-wide listing, migration, current-status field extraction, and task eligibility/running-state predicates; do not hard-code new `$PWD/.agent/<task>` lookups.
