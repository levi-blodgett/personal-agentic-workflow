...
| [pr_publication.py](pr_publication.py) | Shared PR eligibility, visual/body preparation, operation-bound preview snapshots and receipts, branch locks and gh publication/recovery |
